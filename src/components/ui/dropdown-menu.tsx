...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex cursor-default select-none items-center gap-2 rounded-sm px-2 py-1.5 text-sm outline-none transition-colors focus:bg-accent/20 data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&>svg]:size-4",
      inset && "pl-8",
      className
    )}
    {...props}
